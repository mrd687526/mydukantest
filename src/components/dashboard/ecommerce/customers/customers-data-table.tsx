...
async function handleDelete(customerId: string) {
  ...
  if (result.error) {
    toast.error("Failed to delete customer", { description: result.error });
  } else {
...
export const columns: ColumnDef<Customer>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return <div>{lastActive ? format(new Date(lastActive), 'yyyy-MM-dd') : "N/A"}</div>;
    },
  },
  {
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          ...
          <DeleteConfirmationDialog
            ...
            description="This action cannot be undone. This will permanently delete this customer record. Note: Existing orders linked to this customer will have their customer_id set to NULL."
          >
