...
import { DownloadableProductSalesData } from "@/lib/types";

interface DownloadableReportTabProps {
  products: DownloadableProductSalesData[];
}
...
export function DownloadableReportTab({ products }: DownloadableReportTabProps) {
  return (
          ...
          {products && products.length > 0 ? (
            ...
            <TableRow>
              <TableCell colSpan={3} className="h-24 text-center">
                No downloadable products sales found for the selected period.
              </TableCell>
            </TableRow>
          )}
        </TableBody>
